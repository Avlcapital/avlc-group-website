...
export const companyProfiles: Record<string, CompanyProfile> = {
  ...
  "avlc-global-consultants": {
    ...
    introHeading: "WHO WE ARE",
    summary:
      "AVLC Global Consultants Limited is a regional consultancy firm with proven expertise in financial structuring, institutional capacity building, advisory services, and capital access solutions for high-impact financial institutions.",
    intro: [
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "AVLC Global also focuses on advancing financial inclusion by facilitating access to capital for SACCOs, MFIs, and digital credit providers that serve underserved and high-growth market segments. Building on a successfully implemented World Bank-funded SACCO model, AVLC has secured mandates to raise over USD 300 million through debt, equity, and grant structures. These mandates also include marginalized and blue-economy-focused products, with potential integration into the carbon credit ecosystem through strategic partnerships.",
        ],
      },
    ],
  },
